...
\titulo{Projeto de um \textit{datalogger} de baixo custo com interfaces Wi-Fi e Bluetooth}
\data{2022}
\local{Fortaleza}
...
% \membrodabancadois{Prof. Msc. Ricardo Jardel Nunes da Silveira}
% \membrodabancadoiscentro{Centro de Tecnologia (CT)}
\membrodabancadoisies{Universidade Federal Do Ceará (UFC)}
\membrodabancatres{Prof. Dr. Alexandre Augusto da Penha Coelho}
\membrodabancatrescentro{Centro deTecnologia (CT)}
\membrodabancatresies{Universidade Federal Do Ceará (UFC)}
\membrodabancaquatro{Prof. Dr. Jarbas Aryel Nunes da Silveira}
\membrodabancaquatrocentro{Centro de Tecnologia (CT)}
